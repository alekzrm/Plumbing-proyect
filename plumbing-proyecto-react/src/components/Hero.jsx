      ...
      <div className="hero-overlay">
        <div className="hero-container">
          ...
          <p className="hero-description">
            Providing reliable and efficient plumbing services for residential and commercial clients. 
